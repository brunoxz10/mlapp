...
## Criação da função para import file
...
if __name__ == '__main__':
    ...
    st.sidebar.subheader('Trainig Dataset')
    status, df = file_upload('Please upload a trainig dataset')
    ...
    if status == True:
        ...
        with st.expander('Advanced Parameters'):
            ...
            with col2_1:
                ...
                multi_class = st.selectbox('Multi class', ['auto', 'ovr', 'muultinomial'])            
        ...
        try:
            ...
            st.info('Area Unver Curve: **%s**' % (round(auc, 3)))
